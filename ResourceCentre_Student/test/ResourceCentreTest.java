...
public class ResourceCentreTest {
	...
	public void testAddChromebook() {
		...
		// The item just added is as same as the last item in the list
		assertSame("Test that the Chromebook is added to the end of the list.", cb2, chromebookList.get(1));
		...
		Chromebook cb_missing = new Chromebook("CB222", "", "Win 10");
 ...
 public void testRetrieveAllCamcorder() { 
  ...
  String allCamcorder =Camcoders 
  String allCamcorder = ResourceCentre.

retrieveAllCamcorder(camcorderList); 
  String testOutput = ""; 
  ...
  assertEquals("Test that the display is correct.", testOutput, allCamcorder); 
	...
	public void testDoReturnChromebook() {
		...
		assertTrue("Test if the return of CB0011 is successful.",
